  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Shared Account History Sent</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>Dashboard">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Shared Account History</a></li>
              <li class="breadcrumb-item active">Shared Account History Sent</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
       <div class="container-fluid">
        <div class="row">
          <div class="col-12">
<!--               <button type="button" class="btn btn-primary btn-sm" id='send-selected'>sent email confirmation to selected data</button>
              <button type="button" class="btn btn-warning btn-sm" id='send-all-auto'>sent email confirmation to all</button> -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Shared Account History Data Sent</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        function tampil_datatable(){
          ...
          table = $('#table').DataTable({ 
              ...
              "order": [], 
              "ajax": {
                  "url": "<?php echo site_url('SharedAccountHistory/get_data_shared_account_history_sent')?>",
                  "type": "POST",
                  "data": function (d) {
